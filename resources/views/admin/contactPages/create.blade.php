...
<div class="admin-page-head">
    <div>
        ...
        <h2 class="admin-page-title">Add Contact Page</h2>

        <p class="admin-page-subtitle">
            Create dynamic contact page section content for frontend.
        </p>
    </div>
</div>

<form method="POST" action="{{ route('admin.contact-pages.store') }}">
    @csrf
