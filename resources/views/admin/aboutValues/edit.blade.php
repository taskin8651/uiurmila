...
<div class="admin-page-head">
    <div>
        ...
        <h2 class="admin-page-title">Edit Core Value</h2>
        <p class="admin-page-subtitle">Update About page core value</p>
    </div>
</div>
            ...
            <div class="form-card-body">
                <div class="field-group">
                    ...
                    <div class="input-icon-wrap">
                        ...
                        <input type="text" name="number" id="number"
                               value="{{ old('number', $aboutValue->number) }}"
                               placeholder="01"
                ...
                <div class="field-group">
                    ...
                    <div class="input-icon-wrap">
                        ...
                        <input type="text" name="icon" id="icon"
                               value="{{ old('icon', $aboutValue->icon ?? 'bi bi-heart-fill') }}"
                ...
                <div class="field-group">
                    ...
                    <div class="input-icon-wrap">
                        ...
                        <input type="text" name="title" id="title"
                               value="{{ old('title', $aboutValue->title) }}"
                               required
                ...
                <div class="field-group">
                    ...
                    <textarea name="description" id="description" rows="4"
                              ...
                              class="field-input {{ $errors->has('description') ? 'error' : '' }}">{{ old('description', $aboutValue->description) }}</textarea>
                </div>
            </div>
        </div>
                ...
                <div class="field-group">
                    ...
                    <div class="input-icon-wrap">
                        ...
                        <input type="number" name="sort_order" id="sort_order"
                               value="{{ old('sort_order', $aboutValue->sort_order ?? 0) }}"
                               class="field-input">
                    </div>
                </div>
                ...
                <div class="field-group">
                    ...
                    <div class="input-icon-wrap">
                        ...
                        <select name="status" id="status" class="field-input">
                            <option value="1" {{ old('status', $aboutValue->status ?? 1) == 1 ? 'selected' : '' }}>Active</option>
                            <option value="0" {{ old('status', $aboutValue->status ?? 1) == 0 ? 'selected' : '' }}>Inactive</option>
                        </select>
                    </div>
                </div>
            </div>
