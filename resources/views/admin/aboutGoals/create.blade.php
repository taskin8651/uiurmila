...
<div class="admin-page-head">
    <div>
        ...
        <h2 class="admin-page-title">Add Goal</h2>
        <p class="admin-page-subtitle">Create new long-term goal</p>
    </div>
</div>

<form method="POST" action="{{ route('admin.about-goals.store') }}">
    @csrf
        ...
        <div class="form-card">
            <div class="form-card-header">
                ...
                <div>
                    ...
                    <p class="form-card-subtitle">Add goal card content</p>
                </div>
            </div>
                ...
                <div class="field-group">
                    ...
                    <div class="input-icon-wrap">
                        ...
                        <input type="text" name="icon" id="icon"
                               value="{{ old('icon', 'bi bi-people-fill') }}"
