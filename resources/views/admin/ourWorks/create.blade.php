...
@section('page-title', 'Add Our Work Page')
...
<div class="admin-page-head">
    <div>
        ...
        <h2 class="admin-page-title">Add Our Work Page</h2>
        <p class="admin-page-subtitle">Fill frontend Our Work page content</p>
    </div>
</div>

<form method="POST" action="{{ route('admin.our-works.store') }}">
    @csrf
    ...
    <div class="form-actions">
        <button type="submit" class="btn-primary"><i class="fas fa-save"></i> Save Our Work Page</button>
