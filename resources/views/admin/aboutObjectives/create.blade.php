...
@section('page-title', 'Add Objective')
...
<div class="admin-page-head">
    <div>
        ...
        <h2 class="admin-page-title">Add Objective</h2>
        <p class="admin-page-subtitle">Create new About page objective</p>
    </div>
</div>

<form method="POST" action="{{ route('admin.about-objectives.store') }}">
    @csrf
        ...
        <div class="form-card">
            <div class="form-card-header">
                ...
                <div>
                    ...
                    <p class="form-card-subtitle">Add objective text and icon</p>
                </div>
            </div>
                ...
                <div class="field-group">
                    ...
                    <div class="input-icon-wrap">
                        ...
                        <input type="text" name="icon" id="icon"
                               value="{{ old('icon', 'bi bi-check2-circle') }}"
